...
✅ **Completed:**
- Azure infrastructure deployed to subscription `c200e3e7-0839-483b-848b-25a98451f2cd`
...
```bash
# Venv location
/Users/doruit/context-aware-translation/venv
...
|--------------|------|--------------|
| Translator Service | `translate-translator-dev-7bs5gmythqxza` | Custom endpoint |
| App Service | `translate-app-dev-7bs5gmythqxza` | https://translate-app-dev-7bs5gmythqxza.azurewebsites.net |
| Storage Account | `translate7bs5gmyt` | Blob storage for glossaries |
| Application Insights | `translate-insights-dev-7bs5gmythqxza` | Monitoring & logging |
| Log Analytics | `translate-logs-dev-7bs5gmythqxza` | Log aggregation |
| App Service Plan | `translate-plan-dev-7bs5gmythqxza` | B1 Linux plan |
...
az monitor app-insights component show \
  --app translate-insights-dev-7bs5gmythqxza \
  --resource-group rg-translation-dev \
  --query "instrumentationKey" -o tsv

# Access in Azure Portal
open "https://portal.azure.com/#resource/subscriptions/c200e3e7-0839-483b-848b-25a98451f2cd/resourceGroups/rg-translation-dev/providers/microsoft.insights/components/translate-insights-dev-7bs5gmythqxza"
```
